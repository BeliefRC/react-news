...
var TextArea = function (_React$Component) {
    ...
    _createClass(TextArea, [{
        ...
        value: function render() {
            ...
            return React.createElement('textarea', _extends({}, otherProps, { className: classNames(props.prefixCls, props.className), style: style, onKeyDown: this.handleKeyDown, onChange: this.handleTextareaChange, ref: this.saveTextAreaRef }));
        }
    }]);
