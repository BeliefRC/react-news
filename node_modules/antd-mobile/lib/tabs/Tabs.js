...
var Tabs = function (_React$Component) {
    ...
    function Tabs(props) {
        ...
        _this.renderTabBar = function () {
            ...
            return _react2['default'].createElement(_reactNativeScrollableTabView.DefaultTabBar, { activeTextColor: activeTextColor, inactiveTextColor: textColor, style: [barBaseStyle, { borderColor: underlineColor }, barStyle], textStyle: [styles.text], tabStyle: [styles.tab], underlineStyle: underlineStyle });
        };
        _this.activeIndex = 0;
        return _this;
    }
